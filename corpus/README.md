...
An independent, methodologically documented **transparency dataset** of published pricing and buyer-critical product facts across **133 software, SaaS and subscription categories** (**1054 vendors**, **3661 plan records**), last updated 2026-06-15.
...
- `products/<category>.json` — the full product-spec dataset (phones, laptops, GPUs, ...; 404 products across 31 categories).
