...
An independent, methodologically documented **transparency dataset** of published pricing and buyer-critical product facts across **148 software, SaaS and subscription categories** (**1160 vendors**, **4073 plan records**), last updated 2026-06-15.
...
- `products/<category>.json` — the full product-spec dataset (phones, laptops, GPUs, ...; 664 products across 51 categories).
